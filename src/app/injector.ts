...
function injectData(data: Repository[], titleTemplate: string, strategy: (data: Repository[]) => string) {
...
export {
    ...
    setAlphabeticalReposOnScreen,
    setTop5StarredReposOnScreen,
    getFormattedDate,
};
